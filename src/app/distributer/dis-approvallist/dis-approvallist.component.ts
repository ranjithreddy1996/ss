...
@Component({
  selector: 'app-dis-approvallist',
  templateUrl: './dis-approvallist.component.html',
  styleUrls: ['./dis-approvallist.component.css']
})
export class DisApprovallistComponent implements OnInit {
